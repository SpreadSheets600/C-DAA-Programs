...
```bash
gcc BinarySearchIteration.cpp -o BinarySearchIteration && ./BinarySearchIteration
gcc BinarySearchReccursion.cpp -o BinarySearchReccursion && ./BinarySearchReccursion
gcc BinarySearchSort.cpp -o BinarySearchSort && ./BinarySearchSort
```
